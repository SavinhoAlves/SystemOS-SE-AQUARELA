...
//                        . '</p>';
                ...
                foreach ($vendas as $venda):
                    ...
                    $html .= '<tr>';
                    $html .= '<th>' . $venda->venda_id . '</th>';
                    $html .= '<th>' . formata_data_banco_com_hora($venda->venda_data_emissao) . '</th>';
                    $html .= '<th>' . $venda->cliente_nome_completo . '</th>';
                    $html .= '<th>' . $venda->forma_pagamento . '</th>';
                    $html .= '<th>' . 'R$&nbsp;' . $venda->venda_valor_total . '</th>';
                    $html .= '</tr>';
                ...
                $html .= '<td align="center" style="border-top: solid #ddd 1px">' . 'R$&nbsp;' . $valor_final_vendas->venda_valor_total . '</td>';
        ...
        if ($data_inicial) {
            ...
            if ($this->ordem_servicos_model->gerar_relatorio_os($data_inicial, $data_final)) {
                ...
                foreach ($ordens_servicos as $os):
                    ...
                    $html .= '<tr>';
                    $html .= '<th>' . $os->ordem_servico_id . '</th>';
                    $html .= '<th>' . formata_data_banco_com_hora($os->ordem_servico_data_emissao) . '</th>';
                    $html .= '<th>' . $os->cliente_nome_completo . '</th>';
                    $html .= '<th>' . $os->forma_pagamento . '</th>';
                    $html .= '<th>' . 'R$&nbsp;' . $os->ordem_servico_valor_total . '</th>';
                    $html .= '</tr>';
                ...
                $html .= '<td align="center" style="border-top: solid #ddd 1px"><strong>Valor final</strong></td>';
                $html .= '<td align="center" style="border-top: solid #ddd 1px">' . 'R$&nbsp;' . $valor_final_os->ordem_servico_valor_total . '</td>';
            ...
            if ($contas == 'vencidas') {
                ...
                ' . 'E-mail: ' . $empresa->sistema_email . '<br/>
                    ...
                    foreach ($contas as $conta):
                        ...
                        $html .= '<tr>';
                        $html .= '<th>' . $conta->conta_receber_id . '</th>';
                        $html .= '<th>' . formata_data_banco_com_hora($conta->conta_receber_data_vencimento) . '</th>';
                        $html .= '<th>' . $conta->cliente_nome_completo . '</th>';
                        $html .= '<th>Vencida</th>';
                        $html .= '<th>' . 'R$&nbsp;' . $conta->conta_receber_valor . '</th>';
                        $html .= '</tr>';
                    ...
                    $html .= '<td align="center" style="border-top: solid #ddd 1px"><strong>Valor final</strong></td>';
                    $html .= '<td align="center" style="border-top: solid #ddd 1px">' . 'R$&nbsp;' . $valor_final_contas->conta_receber_valor_total . '</td>';
            ...
            if ($contas == 'pagas') {
                ...
                if ($this->financeiro_model->get_contas_receber_relatorio($conta_receber_status)) {
                    ...
                    foreach ($contas as $conta):
                        ...
                        $html .= '<tr>';
                        $html .= '<th>' . $conta->conta_receber_id . '</th>';
                        $html .= '<th>' . formata_data_banco_com_hora($conta->conta_receber_data_pagamento) . '</th>';
                        $html .= '<th>' . $conta->cliente_nome_completo . '</th>';
                        $html .= '<th>Paga</th>';
                        $html .= '<th>' . 'R$&nbsp;' . $conta->conta_receber_valor . '</th>';
                        $html .= '</tr>';
            ...
            if ($contas == 'receber') {
                ...
                if ($this->financeiro_model->get_contas_receber_relatorio($conta_receber_status)) {
                    ...
                    foreach ($contas as $conta):
                        ...
                        $html .= '<tr>';
                        $html .= '<th>' . $conta->conta_receber_id . '</th>';
                        $html .= '<th>' . formata_data_banco_sem_hora($conta->conta_receber_data_vencimento) . '</th>';
                        $html .= '<th>' . $conta->cliente_nome_completo . '</th>';
                        $html .= '<th>A receber</th>';
                        $html .= '<th>' . 'R$&nbsp;' . $conta->conta_receber_valor . '</th>';
                        $html .= '</tr>';
            ...
            if ($contas == 'vencidas') {
                ...
                if ($this->financeiro_model->get_contas_pagar_relatorio($conta_pagar_status, $data_vencimento)) {
                    ...
                    foreach ($contas as $conta):
                        ...
                        $html .= '<tr>';
                        $html .= '<th>' . $conta->conta_pagar_id . '</th>';
                        $html .= '<th>' . formata_data_banco_sem_hora($conta->conta_pagar_data_vencimento) . '</th>';
                        $html .= '<th>' . $conta->fornecedor_nome_fantasia . '</th>';
                        $html .= '<th>Vencida</td>';
                        $html .= '<th>' . 'R$&nbsp;' . $conta->conta_pagar_valor . '</th>';
                        $html .= '</tr>';
                    ...
                    $html .= '<td align="center" style="border-top: solid #ddd 1px"><strong>Valor Final</strong></td>';
                    $html .= '<td align="center" style="border-top: solid #ddd 1px">' . 'R$&nbsp;' . $valor_final_contas->conta_pagar_valor_total . '</td>';
            ...
            if ($contas == 'pagas') {
                ...
                if ($this->financeiro_model->get_contas_pagar_relatorio($conta_pagar_status, $data_vencimento)) {
                    ...
                    foreach ($contas as $conta):
                        ...
                        $html .= '<tr>';
                        $html .= '<th>' . $conta->conta_pagar_id . '</th>';
                        $html .= '<th>' . formata_data_banco_com_hora($conta->conta_pagar_data_pagamento) . '</th>';
                        $html .= '<th>' . $conta->fornecedor_nome_fantasia . '</th>';
                        $html .= '<th>Paga</th>';
                        $html .= '<th>' . 'R$&nbsp;' . $conta->conta_pagar_valor . '</th>';
                        $html .= '</tr>';
