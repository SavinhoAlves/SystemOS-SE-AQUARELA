...
//            exit();
            ...
            foreach ($servicos_ordem as $servico):
                ...
                $html .= '<tr>';
                $html .= '<th>' . $servico->servico_nome . '</th>';
                $html .= '<th>' . $servico->ordem_ts_quantidade . '</th>';
                $html .= '<th>' . 'R$&nbsp;' . $servico->ordem_ts_valor_unitario . '</th>';
                $html .= '<th>' . '%&nbsp;' . $servico->ordem_ts_valor_desconto . '</th>';
                $html .= '<th>' . 'R$&nbsp;' . $servico->ordem_ts_valor_total . '</th>';
                $html .= '</tr>';
            ...
            $html .= '<td align="center" style="border-top: solid #ddd 1px">' . 'R$&nbsp;' . $valor_final_os->os_valor_total . '</td>';
