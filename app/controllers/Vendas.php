...
//            exit();
            ...
            foreach ($produtos_venda as $produto):
                ...
                $html .= '<tr>';
                $html .= '<th>' . $produto->venda_produto_id_produto . '</th>';
                $html .= '<th>' . $produto->produto_descricao . '</th>';
                $html .= '<th>' . $produto->venda_produto_quantidade . '</th>';
                $html .= '<th>' . 'R$&nbsp;' . $produto->venda_produto_valor_unitario . '</th>';
                $html .= '<th>' . '%&nbsp;' . $produto->venda_produto_desconto . '</th>';
                $html .= '<th>' . 'R$&nbsp;' . $produto->venda_produto_valor_total . '</th>';
                $html .= '</tr>';
